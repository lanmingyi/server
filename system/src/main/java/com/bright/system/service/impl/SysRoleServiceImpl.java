...
import com.bright.system.mapper.SysRoleMapper;
import com.bright.system.mapper.SysUserMapper;
import com.bright.system.service.SysRoleService;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public Result importExcelCheckRoleCode(MultipartFile file, ImportParams params) throws Exception {
        ...
        List<String> list = ImportExcelUtil.importDateSave(listSysRoles, SysRoleService.class, errorStrs, CommonConstant.SQL_INDEX_UNIQ_SYS_ROLE_CODE);
