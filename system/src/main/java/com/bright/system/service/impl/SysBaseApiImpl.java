...
import com.bright.common.api.dto.OnlineAuthDTO;
import com.bright.common.api.dto.message.*;
import com.bright.common.aspect.UrlMatchEnum;
import com.bright.common.constant.*;
import com.bright.common.desensitization.util.SensitiveInfoUtil;
import com.bright.common.exception.BaseException;
import com.bright.common.api.SysBaseAPI;
import com.bright.common.system.query.QueryGenerator;
import com.bright.common.system.vo.*;
import com.bright.common.util.SysAnnmentTypeEnum;
import com.bright.common.util.YouBianCodeUtil;
import com.bright.common.util.ConvertUtils;
import com.bright.message.entity.SysMessageTemplate;
import com.bright.message.handle.impl.DdSendMsgHandle;
import com.bright.message.handle.impl.EmailSendMsgHandle;
import com.bright.message.handle.impl.QywxSendMsgHandle;
import com.bright.message.handle.impl.SystemSendMsgHandle;
import com.bright.message.service.ISysMessageTemplateService;
import com.bright.message.websocket.WebSocket;
import com.bright.system.entity.*;
import com.bright.system.mapper.*;
import com.bright.system.service.*;
import com.bright.system.util.SecurityUtil;
	...
	public List<SysPermissionDataRuleModel> queryPermissionDataRule(String component, String requestPath, String username) {
		...
		if(ConvertUtils.isNotEmpty(component)) {
			...
			if(currentSyspermission==null || currentSyspermission.size()==0) {
				...
				//  online菜单如果配置成一级菜单 权限查询不到 取消menuType = 1
