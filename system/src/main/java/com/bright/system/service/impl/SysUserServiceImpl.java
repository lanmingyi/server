...
import com.bright.common.constant.enums.RoleIndexConfigEnum;
import com.bright.common.desensitization.annotation.SensitiveEncode;
import com.bright.common.system.vo.LoginUser;
import com.bright.common.system.vo.SysUserCacheInfo;
import com.bright.common.util.PasswordUtil;
import com.bright.common.util.UUIDGenerator;
...
//	ThirdAppDingtalkServiceImpl dingtalkService;
	...
	public SysRoleIndex getDynamicIndexByUserRole(String username, String version) {
		...
		if (ConvertUtils.isNotEmpty(version) && roles != null && roles.size() > 0) {
		...
		if (ConvertUtils.isEmpty(roleIndex.getComponent())) {
			return null;
		}
		return roleIndex;
	}
...
//	}
	...
	public void saveUser(SysUser user, String selectedRoles, String selectedDeparts) {
		...
		this.save(user);
		// step.2 保存角色
		if (ConvertUtils.isNotEmpty(selectedRoles)) {
