...
import com.bright.common.constant.CacheConstant;
...
import com.bright.common.system.util.ResourceUtil;
import com.bright.common.system.vo.DictModel;
import com.bright.common.system.vo.DictModelMany;
import com.bright.common.system.vo.DictQuery;
import com.bright.common.util.SqlInjectionUtil;
import com.bright.common.util.ConvertUtils;
import com.bright.system.entity.SysDict;
import com.bright.system.entity.SysDictItem;
import com.bright.system.mapper.SysDictItemMapper;
import com.bright.system.mapper.SysDictMapper;
...
//	}
	...
	private String getFilterSql(String table, String text, String code, String condition, String keyword){
		...
		// 判断如果 table 携带了 where 条件，那么就使用 and 查询，防止报错
	...
	public List<DictModel> loadDict(String dictCode, String keyword, Integer pageSize) {
		...
		if (dictCode.contains(SymbolConstant.COMMA)) {
			...
			if (params.length != 3 && params.length != 4) {
				...
				condition = params[3];
				//  online表单下拉搜索框表字典配置#{sys_org_code}报错
