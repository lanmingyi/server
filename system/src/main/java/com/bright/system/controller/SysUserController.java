...
import com.bright.common.aspect.annotation.PermissionData;
...
import com.bright.system.model.SysUserSysDepartModel;
import com.bright.system.service.*;
import com.bright.system.vo.SysDepartUsersVO;
import com.bright.system.vo.SysUserRoleVO;
import com.bright.autopoi.excel.ExcelImportUtil;
...
import com.bright.autopoi.excel.view.EntityExcelView;
...
public class SysUserController {
    ...
    public Result<IPage<SysUser>> queryPageList(SysUser user,
        ...
        if (ConvertUtils.isNotEmpty(code)) {
    ...
    public Result<SysUser> passwordChange(@RequestParam(name = "username") String username,
        ...
        Result<SysUser> result = new Result<SysUser>();
        if (ConvertUtils.isEmpty(username) || ConvertUtils.isEmpty(password) || ConvertUtils.isEmpty(smscode)
                || ConvertUtils.isEmpty(phone)) {
