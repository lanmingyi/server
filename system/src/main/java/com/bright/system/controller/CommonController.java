...
import com.bright.common.util.RestUtil;
import com.bright.common.util.TokenUtils;
...
public class CommonController {
    ...
    @Value(value = "${bright.path.upload}")
    private String uploadpath;

    /**
     * 本地：local minio：minio 阿里：alioss
     */
    @Value(value="${bright.uploadType}")
    ...
    public Result<?> upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(CommonConstant.UPLOAD_TYPE_LOCAL.equals(uploadType)){
            ...
            if(ConvertUtils.isNotEmpty(BasicEditor)){
...
//			if(ConvertUtils.isNotEmpty(tempBizPath)){
//				bizPath = tempBizPath;
//			}
