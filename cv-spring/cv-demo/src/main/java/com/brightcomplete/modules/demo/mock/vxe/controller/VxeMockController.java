package com.brightcomplete.modules.demo.mock.vxe.controller;
...
import com.brightcomplete.common.constant.VxeSocketConst;
import com.brightcomplete.common.system.query.MatchTypeEnum;
import com.brightcomplete.common.system.query.QueryCondition;
import com.brightcomplete.common.system.query.QueryGenerator;
import com.brightcomplete.modules.demo.mock.vxe.entity.MockEntity;
import com.brightcomplete.modules.demo.mock.vxe.websocket.VxeSocket;
...
public class VxeMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:com/brightcomplete/modules/demo/mock/vxe/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:com/brightcomplete/modules/demo/mock/vxe/json/ddjh.json";
        String statusValue = "8";
        if (statusValue.equals(status)) {
            path = "classpath:com/brightcomplete/modules/demo/mock/vxe/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
