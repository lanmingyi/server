package com.brightcomplete.modules.dlglong.controller;
...
import com.brightcomplete.modules.dlglong.entity.MockEntity;
...
public class DlMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:com/brightcomplete/modules/dlglong/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:com/brightcomplete/modules/dlglong/json/ddjh.json";
        String statusValue = "8";
        if (statusValue.equals(status)) {
            path = "classpath:com/brightcomplete/modules/dlglong/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
