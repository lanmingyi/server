...
//@RestController
//@RequestMapping("/test")
//public class CloudDemoFeignController {
//    @Resource
...
//    @ApiOperation(value = "通过feign调用system服务", notes = "测试brightcomplete-demo服务，是否通过feign调用system服务接口")
...
////     *  http://doc.brightcomplete.com/2194069
////     * @return
////     */
////    @GetMapping("/callErp")
...
//        log.info("测试CloudDemoController-remoteDict 熔断降级");
//        return Result.error("测试CloudDemoController-remoteDict 熔断降级");
//    }
//
//}
