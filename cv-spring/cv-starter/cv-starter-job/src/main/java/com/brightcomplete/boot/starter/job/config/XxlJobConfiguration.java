package com.brightcomplete.boot.starter.job.config;

import com.brightcomplete.boot.starter.job.prop.XxlJobProperties;
...
@ConditionalOnProperty(value = "brightcomplete.xxljob.enabled", havingValue = "true", matchIfMissing = true)
