...
import com.brightcomplete.starter.cloud.util.HttpUtils;
import feign.Feign;
import feign.Logger;
...
import com.brightcomplete.common.config.mqtoken.UserTokenContext;
import com.brightcomplete.common.util.PathMatcherUtil;
import com.brightcomplete.starter.cloud.util.SignUtil;
...
public class FeignConfig {
    ...
    /**
     * ::非常重要::
     * 注意：这四个常量值如果修改，需要与 cv-base-core/com.brightcomplete.common.constant.CommonConstant 中的值保持一致。
     */
