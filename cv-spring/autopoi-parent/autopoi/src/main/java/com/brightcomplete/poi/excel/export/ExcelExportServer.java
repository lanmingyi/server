 ...
 */
package com.brightcomplete.poi.excel.export;
...
import com.brightcomplete.poi.util.PoiExcelGraphDataUtil;
...
public class ExcelExportServer extends ExcelExportBase {
	...
	public int createHeaderRow(ExportParams entity, Sheet sheet, Workbook workbook, int feildWidth) {
		...
		//update-begin-author:lmy date:20201118 for:一对多导出needMerge 子表数据对应数量小于2时报错 github#1840、gitee I1YH6B
		try {
		...
		//update-end-author:lmy date:20201118 for:一对多导出needMerge 子表数据对应数量小于2时报错 github#1840、gitee I1YH6B
