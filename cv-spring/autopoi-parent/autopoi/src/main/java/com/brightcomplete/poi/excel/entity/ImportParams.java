 ...
 */
package com.brightcomplete.poi.excel.entity;

import com.brightcomplete.poi.handler.inter.IExcelVerifyHandler;
...
public class ImportParams extends ExcelBaseParams {
	...
	//update-begin for: 导入 ImportParams 中没有startSheetIndex参数
	/**
	 * 开始读取的sheet位置,默认为0
	 */
	private int                 startSheetIndex  = 0;
	//update-end for: 导入 ImportParams 中没有startSheetIndex参数
