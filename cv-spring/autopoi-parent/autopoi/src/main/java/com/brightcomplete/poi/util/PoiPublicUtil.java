 ...
 */
package com.brightcomplete.poi.util;
...
import com.brightcomplete.poi.excel.annotation.ExcelEntity;
import com.brightcomplete.poi.excel.annotation.ExcelIgnore;
import com.brightcomplete.poi.word.entity.params.ExcelListEntity;
import com.brightcomplete.poi.excel.entity.vo.PoiBaseConstants;
import com.brightcomplete.poi.word.entity.WordImageEntity;
	...
	public static String getWebRootPath(String filePath) {
		try {
			...
			try {
				...
				//e.printStackTrace();
			//update-begin for: JAR包分离 发布出空指针
			}catch (NullPointerException e) {
				path =  PoiPublicUtil.class.getProtectionDomain().getCodeSource().getLocation().getPath();
			}
			//update-end for: JAR包分离 发布出空指针
			//update-begin for：解决springboot 启动模式，上传路径获取为空问题
			if (path == null || path == "") {
