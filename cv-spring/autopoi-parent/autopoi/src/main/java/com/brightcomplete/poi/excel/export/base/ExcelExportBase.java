 ...
 */
package com.brightcomplete.poi.excel.export.base;
...
import com.brightcomplete.poi.excel.entity.vo.PoiBaseConstants;
...
import com.brightcomplete.poi.util.MyX509TrustManager;
import com.brightcomplete.poi.util.PoiMergeCellUtil;
	...
	public int createCells(Drawing patriarch, int index, Object t, List<ExcelExportEntity> excelParams, Sheet sheet, Workbook workbook, short rowHeight) throws Exception {
		...
		for (int k = indexKey, paramSize = excelParams.size(); k < paramSize; k++) {
			...
			if (entity.getList() != null) {
				...
				//update-begin-author:lmy date:20201116 for:一对多导出needMerge 子表数据对应数量小于2时报错 github#1840、gitee I1YH6B
				try {
				...
				//update-end-author:lmy date:20201116 for:一对多导出needMerge 子表数据对应数量小于2时报错 github#1840、gitee I1YH6B
				cellNum++;
			}
		}
		return maxHeight;
