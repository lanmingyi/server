...
public class GatewayRoutersConfig {
    ...
    @Value("${brightcomplete.route.config.data-id:#{null}}")
    public void setRouteDataId(String dataId) {
        this.dataId = dataId + ".json";
    }

    @Value("${brightcomplete.route.config.group:DEFAULT_GROUP:#{null}}")
    public void setRouteGroup(String routeGroup) {
        this.routeGroup = routeGroup;
    }

    @Value("${brightcomplete.route.config.data-type:#{null}}")
