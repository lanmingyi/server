package com.brightcomplete.config.mybatis.aspect;
...
import com.brightcomplete.common.aspect.annotation.DynamicTable;
import com.brightcomplete.common.constant.CommonConstant;
import com.brightcomplete.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(com.brightcomplete.common.aspect.annotation.DynamicTable)")
