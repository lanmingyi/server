...
import com.brightcomplete.config.filter.RequestBodyReserveFilter;
...
public class SignAuthConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        String signUrls = baseConfig.getSignUrls();
    ...
    //update-begin for: post请求X_SIGN签名拦截校验后报错, request body 为空
    @Bean
    ...
    //update-end for: post请求X_SIGN签名拦截校验后报错, request body 为空
