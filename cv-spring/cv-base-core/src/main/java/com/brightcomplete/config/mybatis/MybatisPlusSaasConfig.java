package com.brightcomplete.config.mybatis;
...
/**
 * 单数据源配置（brightcomplete.datasource.open = false时生效）
 * @Author lmy
 *
 */
@Configuration
@MapperScan(value={"com.brightcomplete.modules.**.mapper*","com.brightcomplete.**.mapper*"})
