...
public class Swagger2Config implements WebMvcConfigurer {
    ...
    public Docket defaultApi2() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("com.brightcomplete"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                // //大标题
                .title("BrightComplete 后台服务API接口文档")
                // 版本号
                .version("1.0")
//				.termsOfServiceUrl("NO terms of service")
                ...
                .description("后台API接口")
                // 作者
                .contact(new Contact("明成科技","https://github.com/lanmingyi","xxx@xxx.com"))
               // .contact("明成科技")
