...
import com.brightcomplete.common.enums.SentinelErrorInfoEnum;
...
public class BaseExceptionHandler {
	...
	public Result<?> handleCVBootException(BaseException e){
	 ...
	 * 处理自定义微服务异常
	 */
	@ExceptionHandler(CommonCloudException.class)
	public Result<?> handleCVCloudException(CommonCloudException e){
		log.error(e.getMessage(), e);
		return Result.error(e.getMessage());
	}
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(Base401Exception.class)
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public Result<?> handleCVBoot401Exception(Base401Exception e){
		log.error(e.getMessage(), e);
