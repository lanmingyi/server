package com.brightcomplete.common.es;
...
public class ElasticsearchTemplate {
    ...
    public ElasticsearchTemplate(@Value("${brightcomplete.elasticsearch.cluster-nodes}") String baseUrl, @Value("${brightcomplete.elasticsearch.check-enabled}") boolean checkEnabled) {
