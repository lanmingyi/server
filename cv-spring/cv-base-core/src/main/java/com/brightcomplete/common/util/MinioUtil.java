...
import com.brightcomplete.common.util.filter.StrAttackFilter;
...
public class MinioUtil {
    ...
    public static String upload(MultipartFile file, String bizPath, String customBucket) {
        String fileUrl = "";
        //update-begin for: 过滤上传文件夹名特殊字符，防止攻击
        bizPath=StrAttackFilter.filter(bizPath);
        //update-end for: 过滤上传文件夹名特殊字符，防止攻击
    ...
    public static String getObjectUrl(String bucketName, String objectName, Integer expires) {
        initMinio(minioUrl, minioName,minioPass);
        try{
            //update-begin for：获取文件外链报错提示method不能为空，导致文件下载和预览失败
