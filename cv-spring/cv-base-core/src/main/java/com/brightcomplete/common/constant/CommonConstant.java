...
public interface CommonConstant {
    ...
    /**访问权限认证未通过 510*/
    Integer SC_BRIGHTCOMPLETE_NO_AUTHZ=510;

    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.brightcomplete.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
