...
import com.brightcomplete.common.system.query.QueryRuleEnum;
...
public class PermissionDataAspect {
    ...
    @Pointcut("@annotation(com.brightcomplete.common.aspect.annotation.PermissionData)")
    ...
    public Object arround(ProceedingJoinPoint point) throws  Throwable{
        ...
        //update-begin for: online报表带参数的菜单配置数据权限无效
        //先判断是否online报表请求
        // TODO 参数顺序调整有隐患
        ...
        //update-end for: online报表带参数的菜单配置数据权限无效
        ...
        if(dataRules!=null && dataRules.size()>0) {
            //临时存储
            DataAutorUtils.installDataSearchCondition(request, dataRules);
            //TODO 微服务情况下也得支持缓存机制
