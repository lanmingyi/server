package com.brightcomplete.modules.system.test;

import com.alibaba.fastjson.JSONObject;
import com.brightcomplete.SystemApplication;
...
public class SysUserTest {
     ...
     * 测试地址：实际使用时替换成你自己的地址
     */
    private final String BASE_URL = "http://localhost:8080/cv-spring/sys/user/";
    //测试：用户名和密码
