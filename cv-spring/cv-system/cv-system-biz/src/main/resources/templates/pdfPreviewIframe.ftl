...
function openScanFile(title,token,bizNo,archivesNo){
 	 //var pdfUrl ="http://127.0.0.1:8080/cv-spring/generic/web/viewer.html?file="+encodeURIComponent("http://127.0.0.1:8080/cv-spring/test/demo/getPdfUrl?title="+encodeURI(title));
