package com.brightcomplete.modules.quartz.controller;
...
import com.brightcomplete.modules.quartz.entity.QuartzJob;
import com.brightcomplete.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobController {
	...
	public ModelAndView exportXls(HttpServletRequest request, QuartzJob quartzJob) {
        ...
        //获取当前登录用户
        //update-begin---author:lmy ---date:20211227  for：[JTC-116]导出人写死了------------
        LoginUser user = (LoginUser) SecurityUtils.getSubject().getPrincipal();
		mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("定时任务列表数据", "导出人:"+user.getRealname(), "导出信息"));
        //update-end---author:lmy ---date:20211227  for：[JTC-116]导出人写死了------------
