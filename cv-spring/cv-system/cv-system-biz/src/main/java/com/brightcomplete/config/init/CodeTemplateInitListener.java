package com.brightcomplete.config.init;
 ...
 * http://doc.brightcomplete.com/2043922
 */
@Slf4j
@Component
public class CodeTemplateInitListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void initJarConfigCodeGeneratorTemplate() throws Exception {
        ...
        Resource[] resources = resolver.getResources("classpath*:brightcomplete/code-template-online/**/*");
        for (Resource re : resources) {
            ...
            //2.在config下，创建brightcomplete/code-template-online/*模板
            String createFilePath = configPath + filepath.substring(filepath.indexOf("brightcomplete/code-template-online"));
