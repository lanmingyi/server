...
import com.brightcomplete.common.api.dto.message.*;
import com.brightcomplete.common.system.vo.*;
import com.brightcomplete.modules.message.handle.impl.DdSendMsgHandle;
import com.brightcomplete.modules.message.handle.impl.EmailSendMsgHandle;
import com.brightcomplete.modules.message.handle.impl.QywxSendMsgHandle;
import com.brightcomplete.modules.message.handle.impl.SystemSendMsgHandle;
import com.brightcomplete.modules.system.entity.*;
import com.brightcomplete.modules.system.mapper.*;
import com.brightcomplete.modules.system.service.*;
import com.google.common.base.Joiner;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang.StringUtils;
import org.apache.shiro.SecurityUtils;
import com.brightcomplete.common.constant.CacheConstant;
import com.brightcomplete.common.api.dto.OnlineAuthDTO;
...
import com.brightcomplete.common.constant.WebsocketConst;
import com.brightcomplete.common.aspect.UrlMatchEnum;
import com.brightcomplete.common.desensitization.util.SensitiveInfoUtil;
...
import com.brightcomplete.common.util.SysAnnmentTypeEnum;
import com.brightcomplete.common.util.YouBianCodeUtil;
//import com.brightcomplete.common.util.dynamic.db.FreemarkerParseFactory;
...
import com.brightcomplete.modules.message.websocket.WebSocket;
import com.brightcomplete.modules.system.util.SecurityUtil;
...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	public LoginUser getUserByName(String username) {
		// 【v3流程图】测试bug 1、通过我发起的流程或者流程实例，查看历史，流程图预览问题
...
//		}
	...
	public void sendTemplateAnnouncement(TemplateMessageDTO message) {
		...
		if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
			throw new BaseException("消息模板不存在，模板编码："+templateCode);
		}
...
//			throw new BaseException("发送消息失败,消息内容为空！");
//		}
