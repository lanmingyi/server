...
import com.brightcomplete.modules.system.service.impl.SysBaseApiImpl;
...
import com.brightcomplete.modules.system.entity.SysAnnouncement;
import com.brightcomplete.modules.system.entity.SysAnnouncementSend;
import com.brightcomplete.modules.system.service.ISysAnnouncementSendService;
import com.brightcomplete.modules.system.service.ISysAnnouncementService;
import com.brightcomplete.modules.system.util.XssUtils;
...
import static com.brightcomplete.common.constant.CommonConstant.ANNOUNCEMENT_SEND_STATUS_1;
	...
	public Result<Map<String, Object>> listByUser(@RequestParam(required = false, defaultValue = "5") Integer pageSize) {
		...
		if(announcements.size()>0) {
			for(int i=0;i<announcements.size();i++) {
				//update-begin--Author:lmy  Date:20200803  for： 通知公告消息重复LOWCOD-759--------------------
				...
				//update-end--Author:lmy  Date:20200803  for： 通知公告消息重复LOWCOD-759------------
			}
		}
		// 2.查询用户未读的系统消息
