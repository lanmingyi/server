...
import com.brightcomplete.modules.system.entity.SysGatewayRoute;
import com.brightcomplete.modules.system.mapper.SysGatewayRouteMapper;
import com.brightcomplete.modules.system.service.ISysGatewayRouteService;
...
public class SysGatewayRouteServiceImpl extends ServiceImpl<SysGatewayRouteMapper, SysGatewayRoute> implements ISysGatewayRouteService {
    ...
    public void updateAll(JSONObject json) {
        ...
        try {
            ...
            //update-begin for: oracle路由网关新增小bug
            ...
            //update-end for: oracle路由网关新增小bug
