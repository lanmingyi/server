...
import com.brightcomplete.modules.system.entity.SysDepartPermission;
import com.brightcomplete.modules.system.entity.SysDepartRolePermission;
...
import com.brightcomplete.modules.system.service.ISysDepartPermissionService;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import lombok.extern.slf4j.Slf4j;
import com.brightcomplete.common.system.base.controller.BaseController;
import com.brightcomplete.modules.system.service.ISysDepartRolePermissionService;
	...
	public Result<?> saveDatarule(@RequestBody JSONObject jsonObject) {
	 ...
	 public Result<String> saveDeptRolePermission(@RequestBody JSONObject json) {
		 ...
		 try {
			 ...
			 result.success("保存成功！");
             //update-begin---author:lmy ---date:20220316  for：[VUEN-234]部门角色授权添加敏感日志------------
             LoginUser loginUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
             baseCommonService.addLog("修改部门角色ID:"+roleId+"的权限配置，操作人： " +loginUser.getUsername() ,CommonConstant.LOG_TYPE_2, 2);
             //update-end---author:lmy ---date:20220316  for：[VUEN-234]部门角色授权添加敏感日志------------
