package com.brightcomplete.modules.monitor.controller;

import com.alibaba.fastjson.JSONArray;
import com.brightcomplete.modules.monitor.service.RedisService;
...
public class ActuatorRedisController {
  ...
  //update-begin--Author:lmy  Date:20190425 for：获取磁盘信息
  	/**
  	 * @功能：获取磁盘信息
  	 * @param request
  	 * @param response
  	...
  	//update-end--Author:lmy  Date:20190425 for：获取磁盘信息
}
