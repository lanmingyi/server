...
import com.brightcomplete.common.constant.enums.RoleIndexConfigEnum;
import com.brightcomplete.common.desensitization.annotation.SensitiveEncode;
import com.brightcomplete.common.system.vo.LoginUser;
import com.brightcomplete.common.system.vo.SysUserCacheInfo;
import com.brightcomplete.common.util.PasswordUtil;
import com.brightcomplete.common.util.UUIDGenerator;
...
import com.brightcomplete.modules.system.vo.SysUserDepVo;
			...
			for (SysUserDepart depart : userDepartList) {
				...
				if (!Arrays.asList(arr).contains(depart.getDepId())) {
					List<SysDepartRole> sysDepartRoleList = sysDepartRoleMapper.selectList(
							new QueryWrapper<SysDepartRole>().lambda().eq(SysDepartRole::getDepartId,
									depart.getDepId()));
