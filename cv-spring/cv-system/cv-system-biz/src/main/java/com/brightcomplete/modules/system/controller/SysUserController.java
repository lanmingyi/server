...
import com.brightcomplete.common.aspect.annotation.PermissionData;
import com.brightcomplete.common.constant.CommonConstant;
import com.brightcomplete.common.constant.SymbolConstant;
import com.brightcomplete.common.util.ImportExcelUtil;
...
import com.brightcomplete.modules.system.model.SysUserSysDepartModel;
import com.brightcomplete.modules.system.vo.SysDepartUsersVO;
import com.brightcomplete.modules.system.vo.SysUserRoleVO;
...
public class SysUserController {
    ...
    public Result<IPage<SysUser>> queryUserComponentData(
        ...
        SqlInjectionUtil.filterContent(arr, SymbolConstant.SINGLE_QUOTATION_MARK); // 【禁止问题】sql注入漏洞
        ...
        try {
            ...
            if (sysUser == null) {
                ...
                if (StringUtils.isNotBlank(email)) {
                    // update-begin---author:lmy ---date:20220708
                    ...
                    // update-end---author:lmy ---date:20220708
                    // for：[VUEN-1528]积木官网邮箱重复，应该提示准确--------------
