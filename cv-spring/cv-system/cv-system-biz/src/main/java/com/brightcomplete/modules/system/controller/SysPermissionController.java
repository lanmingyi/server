...
import com.brightcomplete.common.util.Md5Util;
...
import com.brightcomplete.modules.system.model.SysPermissionTree;
import com.brightcomplete.modules.system.model.TreeModel;
import com.brightcomplete.modules.system.util.PermissionDataUtil;
...
//	}
	...
	public Result<?> getUserPermissionByToken(HttpServletRequest request) {
		...
		try {
			...
			json.put("sysSafeMode", baseConfig.getSafeMode());
	...
	public Result<?> getPermCode() {
		try {
            ...
            // 系统安全模式
			result.put("sysSafeMode", baseConfig.getSafeMode());
	...
	/**
	 * 判断是否外网URL 例如： http://localhost:8080/cv-spring/swagger-ui.html#/ 支持特殊格式： {{
