...
import com.brightcomplete.modules.system.vo.SysUserOnlineVO;
    ...
    public Result<Page<SysUserOnlineVO>> list(@RequestParam(name="username", required=false) String username,
        ...
        for (String key : keys) {
            ...
            if (StringUtils.isNotEmpty(token)) {
                ...
                if (loginUser != null) {
                    //update-begin---author:lmy ---date:20220104  for：[JTC-382]在线用户查询无效------------
                    //验证用户名是否与传过来的用户名相同
                    ...
                    //update-end---author:lmy ---date:20220104  for：[JTC-382]在线用户查询无效------------
                }
            }
        }
