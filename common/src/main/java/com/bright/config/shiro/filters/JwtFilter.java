package com.bright.config.shiro.filters;

import com.bright.common.config.TenantContext;
...
import com.bright.config.shiro.JwtToken;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
        ...
        // 提交给realm进行登入，如果错误他会抛出异常并被捕获。这个方法AuthenticationInfo
