package com.bright.config.mybatis.aspect;

import com.bright.common.aspect.annotation.DynamicTable;
import com.bright.common.constant.CommonConstant;
import com.bright.common.util.SpringContextUtils;
import com.bright.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(com.bright.common.aspect.annotation.DynamicTable)")
