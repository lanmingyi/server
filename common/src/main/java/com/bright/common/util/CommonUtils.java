...
import com.bright.common.constant.ServiceNameConstants;
import com.bright.common.constant.SymbolConstant;
import com.bright.common.util.filter.FileTypeFilter;
import com.bright.common.util.oss.OssBootUtil;
...
public class CommonUtils {
    ...
    public static String getFileName(String fileName){
        ...
        // online 在线表单 使用文件组件时，上传文件名中含%，下载异常
