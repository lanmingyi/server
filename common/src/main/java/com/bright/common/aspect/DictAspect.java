package com.bright.common.aspect;
...
import com.bright.common.aspect.annotation.Dict;
...
public class DictAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("execution(public * com.bright.modules..*.*Controller.*(..)) || @annotation(com.bright.common.aspect.annotation.AutoDict)")
        ...
        if (result instanceof Result) {
            if (((Result) result).getResult() instanceof IPage) {
                ...
                for (Object record : records) {
                    ...
                    // restcontroller返回json数据后key顺序错乱
